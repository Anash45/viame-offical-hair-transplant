    ...
    <div class="row footer-main">
      ...
      <div class="col-sm-6 col-md-3">
        ...
        <ul class="footer-links">
          <?php foreach ($footerQuickLinks as $link): ?>
            <li><a
                href="<?= htmlspecialchars($link['href'], ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($link['label'], ENT_QUOTES, 'UTF-8') ?></a>
            </li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div class="col-sm-6 col-md-3">
        ...
        <ul class="footer-contact">
          ...
          <li><i class="fa fa-envelope"></i> <a
              href="mailto:info@officialhairclinic.com">info@officialhairclinic.com</a></li>
      ...
      <div class="col-sm-6 col-md-3">
        ...
        <ul class="team-social">
          <li><a href="https://www.instagram.com/officialhairclinic" target="_blank" rel="noopener noreferrer"><i
                class="fab fa-instagram"></i></a></li>
          <li><a href="https://www.facebook.com/officialhairclinic" target="_blank" rel="noopener noreferrer"><i
                class="fab fa-facebook"></i></a></li>
          <li><a href="https://www.tiktok.com/@officialhairclinic" target="_blank" rel="noopener noreferrer"><i
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.mobile-menu-link a').forEach(function(link) {
