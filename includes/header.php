  ...
  <div class="container">
    <div class="row header-row">
      <div class="col-md-4 col-xs-6">
        <a class="logo" href="index.php"><img loading="lazy" alt="logo" src="images/logo.png" /></a>
      </div>
      <div class="col-md-8">
        ...
        <ul class="navigation nav-collapse">
          <?php foreach ($navItems as $key => $item): ?>
            <li<?= $currentPage === $key ? ' class="current"' : '' ?>><a
                href="<?= htmlspecialchars($item['href'], ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($item['label'], ENT_QUOTES, 'UTF-8') ?></a>
              </li>
            <?php endforeach; ?>
            <li class="mobile-menu-link">

              <a class="header-call-desktop" href="#contact-form" aria-label="Book Consultation">
